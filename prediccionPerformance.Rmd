...
# Uso de la Función Enviada, Predecir.R
  ...
  Esta espera encontrar en el directorio donde se halle un archivo llamado `tests.txt` con el mismo formato del archivo que `Concurso_Estima.txt` que recibimos. 
  
  Al ejecutar `predecir.R` esta levanta la sesión llamada `modelo.RData` que contiene el modelo seleccionado entrenado y genera las predicciones, que quedan almacenadas en un nuevo archivo llamado `preds.txt`.
